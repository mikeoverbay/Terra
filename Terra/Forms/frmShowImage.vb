...
Public Class frmShowImage
    ...
    Private Sub populate_list()
        ...
        For map = 0 To maplist.Length - 2
            ...
            Next
            For i = 1 To 4
                If map_layers(map).layers(i).mix_texture_Id > 0 Then
                    ListBox1.Items.Add(map_layers(map).layers(i).mix_texture_Id.ToString + vbTab + " : Map " + map.ToString + "     " + vbTab + "Mixing Texture")
